...
<body>
  ...
  <a href="changepass.php">Contraseña</a>
	...
	<div class="regi" >
		<p align="center"><br><b>INICIAR SESIÓN</b></p><br>
		<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
			
			<label>Email ID</label>
			<br>
			<input type="email" name="email" placeholder="Identificación Correo" required="" />
			<br><br>
		...
		<label>¿Aún no tienes una cuenta? <a href="../register.php">REGISTRARSE</a></label><br><br>
