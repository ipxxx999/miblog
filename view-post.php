...
<html>
<head><?php echo "
	<title>".$row['title']."- Anti-Scan Defender "."</title>";
	?>
	<meta charset="utf-8">
...
<div class="artic" >
		<label class="title"><b><?php echo $row['title'] ?></b></label><br></p>
...
if(isset($_SESSION['ID']))
{
	echo "<div class='addcomform'>
			...
			<br>
			<textarea cols='80' rows='3' name='com'></textarea></p>
			<input type='submit' class='greenkaro' name='comment' value='PUBLICAR COMENTARIO'>
		</form>
		</div>";
}
else
{
	echo "<a href='admin/login.php'>Iniciar Sesión</a> para publicar comentario";
}
...
<br></p>.</p>.</p><footer class="fut" align="center"><p>Anti-Scan Blog 2022</p></footer>
<a href="http://larry.serveftp.com/index.php"><img src="http://larry.serveftp.com/simulador/spacer.gif" alt="Blog" width="1" height="1"></a>
</body>
</html>